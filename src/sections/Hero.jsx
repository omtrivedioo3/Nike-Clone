  ...
  return (
    ...
    <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
      ...
      font-bold">
        ...
        <p className="font-montserrat text-gray-400 text-lg leading-8 mt-6 mb-14 sm:max-w-sm">Discover stylish Nike arrrivals,quality comfort,and innovation for your active life</p>
    ...
    <div className="relative flex-1 flex justify-center items-center xl:min-h-screen max-xl:py-40 bg-purple-50 bg-hero bg-cover bg-center">
      <img 
      src={bigShoeImg}
      alt="show collection"
      width={610}
